...
export default function CartDrawer({ open, onClose, storeOpen = true }) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end">
      ...
      <div className="relative w-full max-w-sm bg-paper h-full flex flex-col shadow-xl">
        <div className="px-5 py-4 border-b border-crust/10 flex items-center justify-between">
        ...
        <div className="px-5 py-4 border-t border-crust/10 space-y-3">
